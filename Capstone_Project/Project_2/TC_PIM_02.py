...
class Orange:
    ...
    def __init__(self):
        ...
        self.user_management = '//span[normalize-space()="User Management"]'
        self.nationalities = '//a[normalize-space()="Nationalities"]'
    ...
    def orange_login(self):
        ...
        admin_webelement = self.driver.find_element(By.XPATH, self.admin)
